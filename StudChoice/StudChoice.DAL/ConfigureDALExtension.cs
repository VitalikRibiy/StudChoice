...
namespace StudChoice.DAL
{
    public static class ConfigureDALExtension
    {
        ...
        private static void ConfigureDbContext(
            ...
            IConfiguration configuration)
        {
            services.AddDbContext<StudChoiceContext>(options => options.EnableSensitiveDataLogging().UseSqlServer(configuration.GetConnectionString("DefaultConnection"), x=>x.MigrationsAssembly("StudChoice.DAL")));
        }
