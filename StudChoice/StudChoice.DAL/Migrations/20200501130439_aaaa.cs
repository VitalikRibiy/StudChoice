        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Dv1Id = table.Column<int>(nullable: true),
                    Dv2Id = table.Column<int>(nullable: true),
                    Dvvs1Id = table.Column<int>(nullable: true),
                    Dvvs2Id = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastName = table.Column<string>(nullable: true),
                    FacultyId = table.Column<long>(nullable: false),
                    CathedraId = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Professors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Professors_Cathedras_CathedraId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedStudentsCount = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
